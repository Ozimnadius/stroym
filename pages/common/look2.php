...
<div class="look look_product">
    <div class="container">
        ...
        <div class="look__slider">
            ...
            <div class="swiper-container look__container">
                <div class="swiper-wrapper">
                    <? for ($i = 1; $i < 13; $i++): ?>
                        <a role="link" href="product.php" title="Товар<?= $i ?>" class="swiper-slide item jsItem"
                           data-id="<?= $i ?>">
                            <!-- img -->
